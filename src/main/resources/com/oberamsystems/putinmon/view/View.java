...
public class View {
	...
	public View(JTable table) {
        ...
        JButton checkButton = new JButton("Manually check availability");
        ...
        menu.addMenuListener(new MenuListener() {
			...
			public void menuSelected(MenuEvent e) {
				JOptionPane.showMessageDialog(null, "This program is intended to monitor the Anonymous actions against Russia.", "Help", JOptionPane.INFORMATION_MESSAGE);
			}
